    ...
    const fetchData = async () => {
      ...
      const [questionsRes, optionsRes] = await Promise.all([
        supabase
          ...
          .eq('testid', 5)
          .eq('dat_type', 'razonamiento_numerico')
          .order('id'),

        // Si tus preguntas no tienen opciones todavía, puedes dejar esto igual
        // o comentar todo el RadioGroup más abajo.
        supabase
          .from('answeroptions')
