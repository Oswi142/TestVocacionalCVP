...
const DatEspacial: React.FC = () => {
    const user = JSON.parse(localStorage.getItem('user') || '{}');
    const navigate = useNavigate();
    const STORAGE_KEY = `dat_espacial_${user.id || 'anonymous'}`;
    const TEST_ID = 5;
    const DAT_TYPE = 'razonamiento_espacial';
        ...
        <Box sx={{
            ...
            <Box sx={{
                ...
                <Box sx={{ padding: 2, borderBottom: '1px solid #e0e0e0', flexShrink: 0 }}>
                    ...
                    <Typography variant="h5" color="primary">Test: Relaciones Espaciales</Typography>
